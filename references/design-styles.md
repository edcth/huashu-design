...
> 用於視覺設計（網頁/PPT/PDF/信息圖/配圖/App等）的設計風格庫。
> 每種風格提供：哲學內核 + 核心特徵 + 提示詞DNA（與場景模板組合使用）。

## 風格×場景×執行路徑 速查表

| 風格 | 網頁 | PPT | PDF | 信息圖 | 封面 | AI生成 | 最佳路徑 |
|------|:---:|:---:|:---:|:-----:|:---:|:-----:|---------|
| 01 Pentagram | ★★★ | ★★★ | ★★☆ | ★★☆ | ★★★ | ★☆☆ | HTML |
| 02 Stamen Design | ★★☆ | ★★☆ | ★★☆ | ★★★ | ★★☆ | ★★☆ | 混合 |
...
> 最佳路徑：AI生成（圖片直出）/ HTML（代碼渲染，數據精確）/ 混合（HTML佈局+AI配圖）

**核心規律**：有明確視覺元素的風格（插畫/粒子/生成藝術）AI直出效果好；依賴精確排版和數據的風格（網格/信息架構/留白）HTML渲染更可控。
...
**搜索關鍵詞**：pentagram hillary logo system

---

### 02. Stamen Design - 數據詩學
**哲學**：讓數據成為可觸摸的風景
**核心特徵**：
- 地圖學思維應用於信息設計
- 算法生成的有機圖形
- 溫暖的數據可視化色調（赭石、鼠尾草綠、深藍）
- 可交互的層級系統
...
**搜索關鍵詞**：stamen covid map visualization
...
**代表作**：iA Writer app
**搜索關鍵詞**：information architects ia writer
...
**搜索關鍵詞**：fathom information design gates foundation
...
**搜索關鍵詞**：locomotive scroll lusion
...
**代表作**：NASA Prospect
**搜索關鍵詞**：active theory nasa webgl
...
**搜索關鍵詞**：field.io generative design
...
**搜索關鍵詞**：resn interactive storytelling
...
**搜索關鍵詞**：experimental jetset whitney responsive w
...
**搜索關鍵詞**：muller brockmann grid systems poster
...
**搜索關鍵詞**：build studio london branding
...
**代表作**：The Happy Show
**搜索關鍵詞**：sagmeister walsh happy show
...
**搜索關鍵詞**：zach lieberman openframeworks generative
...
**搜索關鍵詞**：raven kwok processing generative art
...
**搜索關鍵詞**：ash thorp ghost shell concept art

---

### 16. Territory Studio - 屏幕界面虛構
**哲學**：未來UI的今日想象
**核心特徵**：
- 科幻電影中的屏幕設計（FUI）
- 全息投影感
...
**搜索關鍵詞**：territory studio blade runner interface
...
**搜索關鍵詞**：takram nhk data visualization
...
**搜索關鍵詞**：kenya hara designing design muji
...
**搜索關鍵詞**：irma boom shv think book
...
**搜索關鍵詞**：neo shen digital ink wash art
...
AI圖像生成的關鍵：短提示詞 > 長提示詞。描述3句情緒和內容，比30行佈局細節效果更好。
...
- **HTML渲染**：依賴精確排版的風格（01/03/04/10/11/17/18），代碼控制數據和佈局
...
**版本**：v2.1
**更新日期**：2026-02-13
**適用場景**：網頁/PPT/PDF/信息圖/封面/配圖/App等所有視覺設計
**與 image-to-slides 聯動**：PPT場景可直接引用本文件風格，通過 image-to-slides skill 執行生成
